  ...
  return (
    ...
    >
      <ul className="list-group list-group-flush">
        ...
        <li className="list-group-item bg-light bg-gradient">
          Dijkstra's Algorithm finds the shortest path between source node and
          destination node for any weighted,directed graph with non-negative
          weights.
        </li>
        <li className="list-group-item">
          Breadth First Search (BFS) is an algorithm for traversing or searching
          tree or graph data structures. It explores all the nodes at the
